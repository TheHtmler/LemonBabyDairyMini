...
test('nutrition profile settings v2 page exposes formula powder profiles without mixing plan UI', () => {
  const source = fs.readFileSync('miniprogram/pages/nutrition-profile-settings/index.js', 'utf8');
  const wxml = fs.readFileSync('miniprogram/pages/nutrition-profile-settings/index.wxml', 'utf8');
  const wxss = fs.readFileSync('miniprogram/pages/nutrition-profile-settings/index.wxss', 'utf8');
...
test('legacy nutrition settings page remains on the old entry model', () => {
  const source = fs.readFileSync('miniprogram/pages/nutrition-settings/index.js', 'utf8');
