...
function loadV2Page(options = {}) {
  const pagePath = require.resolve('../miniprogram/pages/milk-feeding-editor-v2/index.js');
...
test('milk feeding v2 page renders v1-style editor with a unified optional component list', () => {
  const source = fs.readFileSync('miniprogram/pages/milk-feeding-editor-v2/index.js', 'utf8');
  const wxml = fs.readFileSync('miniprogram/pages/milk-feeding-editor-v2/index.wxml', 'utf8');
  const wxss = fs.readFileSync('miniprogram/pages/milk-feeding-editor-v2/index.wxss', 'utf8');
