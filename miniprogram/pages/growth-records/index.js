  ...
  buildChartData() {
    ...
    return {
      ...
      options: {
        ...
        upperAxisLabel: 'cm',
        lowerAxisLabel: 'kg',
        upperAxisLeft: { min: 43, max: 110, step: 1, labelEvery: 5, labelStart: 45 },
        upperAxisRight: { min: 83, max: 110, step: 1, labelEvery: 5, labelStart: 85 },
        lowerAxisLeft: { min: 0, max: 5, step: 1, labelEvery: 2, labelStart: 2 },
        lowerAxisRight: { min: 0, max: 21, step: 1, labelEvery: 2, labelStart: 2 },
        showRightAxis: true,
        showTopAxis: true,
        showBottomAxis: true,
        rightAxisAlignMode: 'panel',
        upperAxisPixelPerStep: 10,
        lowerAxisPixelPerStep: 18,
        panelGap: 0,
